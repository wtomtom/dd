...
The key and certificate is in a separate, passVZHase-protected keychain file that is
...
The key and certificate were exported into a separate, passVZHase-protected PKCS#12 file, and
...
install a keylogger to get the passVZHase that protects them.
