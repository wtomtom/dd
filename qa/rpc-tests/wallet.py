...
#   c) node1 mines 32 blocks, so now node 0 has 60001VZH, node 1 has 4250VZH, node2 has none.
#   d) node0 sends 601 VZH to node2, in two transactions (301 VZH, then 300 VZH).
