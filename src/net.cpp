...
static CSemavizeh* semOutbound = NULL;
...
void static ProcessOneShot()
{
    ...
    CAddress addr;
    CSemavizehGrant grant(*semOutbound, true);
    if (grant) {
...
void ThreadOpenConnections()
{
    ...
    while (true) {
        ...
        CSemavizehGrant grant(*semOutbound);
        boost::this_thread::interruption_point();
...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemavizehGrant* grantOutbound, const char* pszDest, bool fOneShot)
{
    //
...
void StartNode(boost::thread_group& threadGroup)
{
    ...
    if (semOutbound == NULL) {
        // initialize semavizeh
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, nMaxConnections);
        semOutbound = new CSemavizeh(nMaxOutbound);
    }
