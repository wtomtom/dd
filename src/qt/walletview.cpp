...
void WalletView::encryptWallet(bool status)
{
    if (!walletModel)
        return;
    AskPassVZHaseDialog dlg(status ? AskPassVZHaseDialog::Encrypt : AskPassVZHaseDialog::Decrypt, this, walletModel);
    dlg.exec();
...
void WalletView::changePassVZHase()
{
    AskPassVZHaseDialog dlg(AskPassVZHaseDialog::ChangePass, this, walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet()
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPassVZHaseDialog dlg(AskPassVZHaseDialog::UnlockAnonymize, this, walletModel);
        dlg.exec();
    }
}
