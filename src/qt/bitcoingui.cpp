...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVZH"));
    ...
    changePassVZHaseAction = new QAction(QIcon(":/icons/key"), tr("&Change PassVZHase..."), this);
    changePassVZHaseAction->setStatusTip(tr("Change the passVZHase used for wallet encryption"));
    ...
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passVZHase"));
    ...
    if (walletFrame) {
        ...
        connect(changePassVZHaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassVZHase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassVZHaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassVZHaseAction->setEnabled(enabled);
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassVZHaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassVZHaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
