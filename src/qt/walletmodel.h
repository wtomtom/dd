...
public:
    ...
    // Wallet encryption
    bool setWalletEncrypted(bool encrypted, const SecureString& passVZHase);
    // PassVZHase only needed when unlocking
    bool setWalletLocked(bool locked, const SecureString& passVZHase = SecureString(), bool anonymizeOnly = false);
    bool changePassVZHase(const SecureString& oldPass, const SecureString& newPass);
