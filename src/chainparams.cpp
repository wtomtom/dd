...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x00000733bb36aaed4e452ac90bde005df7d76948caf3e71ee25538580dae4f73"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 30; // vizeh: 1 day
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 1 * 10;  // vizeh: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
