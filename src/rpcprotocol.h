...
enum RPCErrorCode {
    ...
    RPC_WALLET_UNLOCK_NEEDED = -13,        //! Enter the wallet passVZHase with walletpassVZHase first
    RPC_WALLET_PASSVZHASE_INCORRECT = -14, //! The wallet passVZHase entered was incorrect
