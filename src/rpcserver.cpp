...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"vizeh", "listmasternodes", &listmasternodes, true, true, false},
        {"vizeh", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vizeh", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vizeh", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vizeh", "masternodedebug", &masternodedebug, true, true, false},
        {"vizeh", "startmasternode", &startmasternode, true, true, false},
        {"vizeh", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vizeh", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vizeh", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vizeh", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vizeh", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vizeh", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vizeh", "mnbudget", &mnbudget, true, true, false},
        {"vizeh", "preparebudget", &preparebudget, true, true, false},
        {"vizeh", "submitbudget", &submitbudget, true, true, false},
        {"vizeh", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vizeh", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vizeh", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vizeh", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vizeh", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vizeh", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vizeh", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vizeh", "checkbudgets", &checkbudgets, true, true, false},
        {"vizeh", "mnsync", &mnsync, true, true, false},
        {"vizeh", "spork", &spork, true, true, false},
        {"vizeh", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        ...
        {"wallet", "walletpassVZHasechange", &walletpassVZHasechange, true, false, true},
        {"wallet", "walletpassVZHase", &walletpassVZHase, true, false, true},
