...
extern std::string HelpRequiringPassVZHase();
...
extern json_spirit::Value walletpassVZHase(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value walletpassVZHasechange(const json_spirit::Array& params, bool fHelp);
