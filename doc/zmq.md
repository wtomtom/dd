...
The vizeh Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in vizeh Core requires ZeroMQ API version 4.x or
...
during the *configure* step of building vizehd:
